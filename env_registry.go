...
var envRegistry = []EnvVar{
	...
	{Name: "PAPERLESS_CREATED_CORRESPONDENT_CHANGE_GROUP_IDS", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional comma-separated paperless-ngx group IDs granted change permission on newly created correspondents."},
	{Name: "PAPERLESS_CREATED_CORRESPONDENT_IS_INSENSITIVE", Category: "Tags & automation", Secret: false, Default: "true", Description: "Boolean applied to newly created correspondents' `is_insensitive` field in paperless-ngx."},
	{Name: "PAPERLESS_CREATED_CORRESPONDENT_MATCH", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional match pattern applied to newly created correspondents' `match` field in paperless-ngx."},
	{Name: "PAPERLESS_CREATED_CORRESPONDENT_MATCHING_ALGORITHM", Category: "Tags & automation", Secret: false, Default: "0", Description: "Paperless-ngx matching algorithm ID applied to newly created correspondents."},
	{Name: "PAPERLESS_CREATED_CORRESPONDENT_OWNER_ID", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional owner user ID applied to newly created correspondents. Set to `null` to explicitly clear the owner. Without this and the view/change group IDs, new correspondents are owned by the Paperless-GPT service account and render as \"Private\" for other users."},
	{Name: "PAPERLESS_CREATED_CORRESPONDENT_VIEW_GROUP_IDS", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional comma-separated paperless-ngx group IDs granted view permission on newly created correspondents."},
	{Name: "PAPERLESS_CREATED_DOCUMENT_TYPE_CHANGE_GROUP_IDS", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional comma-separated paperless-ngx group IDs granted change permission on newly created document types."},
	{Name: "PAPERLESS_CREATED_DOCUMENT_TYPE_IS_INSENSITIVE", Category: "Tags & automation", Secret: false, Default: "true", Description: "Boolean applied to newly created document types' `is_insensitive` field in paperless-ngx."},
	{Name: "PAPERLESS_CREATED_DOCUMENT_TYPE_MATCH", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional match pattern applied to newly created document types' `match` field in paperless-ngx."},
	{Name: "PAPERLESS_CREATED_DOCUMENT_TYPE_MATCHING_ALGORITHM", Category: "Tags & automation", Secret: false, Default: "0", Description: "Paperless-ngx matching algorithm ID applied to newly created document types."},
	{Name: "PAPERLESS_CREATED_DOCUMENT_TYPE_OWNER_ID", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional owner user ID applied to newly created document types. Set to `null` to explicitly clear the owner. Without this and the view/change group IDs, new document types are owned by the Paperless-GPT service account and render as \"Private\" for other users."},
	{Name: "PAPERLESS_CREATED_DOCUMENT_TYPE_VIEW_GROUP_IDS", Category: "Tags & automation", Secret: false, Default: "", Description: "Optional comma-separated paperless-ngx group IDs granted view permission on newly created document types."},
